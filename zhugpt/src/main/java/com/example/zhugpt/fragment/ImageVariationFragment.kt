...
class ImageVariationFragment : Fragment() {
    private lateinit var mBinding : FragmentImageVariationBinding
    private var mChatList = ArrayList<ChatItem>()

    companion object{
        public fun newInstance() : ImageVariationFragment {
            return ImageVariationFragment()
        }
    }
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentImageVariationBinding.inflate(inflater, container, false)
